...
public class TestGameMonsters extends Application{
    ...
    //the highest number tickcount can go to before it resets (to stop it getting too big)
    ...
    private static TestGameMonsters instance;
    private LevelLoader levelLoader;

    private String levelName = "level2";

    public static TestGameMonsters getInstance() {
        if (instance == null) {
            instance = new TestGameMonsters();
        }
        return instance;
    }
